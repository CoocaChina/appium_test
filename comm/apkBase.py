...
if __name__ == '__main__':
    ApkInfo('/Users/shijifeng/PycharmProjects/appium_test/testApp/bossbb-android-release-1619593549681.apk').get_apk_pkg()
    # ApkInfo(r"D:\app\appium_study\img\t.apk").get_apk_version()
    # ApkInfo(r"D:\app\appium_study\img\t.apk").get_apk_name()
    ApkInfo('/Users/shijifeng/PycharmProjects/appium_test/testApp/bossbb-android-release-1619593549681.apk').get_apk_activity()
